  ...
  return (
    <div className="p-8 rounded-3xl glass-panel space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold tracking-tight">Interactive Panel</h2>
        <button
          onClick={onReset}
          disabled={loading}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
          <span className="text-[10px] uppercase tracking-widest text-gray-500 block mb-1">Method</span>
          <span className="text-sm font-medium">REST API / JSON</span>
        </div>
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
          <span className="text-[10px] uppercase tracking-widest text-gray-500 block mb-1">Persistence</span>
